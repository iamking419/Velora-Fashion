...
const FontLink = () => (
  <style>{`
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    @keyframes slideInRightMobile { from { opacity:0; transform:translateX(20px); } to { opacity:1; transform:translateX(0); } }
    @keyframes pulseMobile { 0%,100%{transform:scale(1)} 50%{transform:scale(1.05)} }
...
function CartDrawer() {
  ...
  return (
    <>
      ...
      <div className="drawer-box" role="dialog" aria-modal="true" aria-label="Shopping bag" style={{ width: "min(440px, 100vw)" }}>
    ...
    <section className="hero-section" style={{ position:"relative", height:"100vh", minHeight:700, overflow:"hidden", display:"flex", flexDirection:"column", alignItems:"center", justifyContent:"center" }}>
      ...
      <div className="container-px" style={{ position:"relative", zIndex:2, maxWidth:1400, margin:"0 auto", padding:"0 48px", width:"100%" }}>
        <div style={{ maxWidth:580, width: "100%" }}>
          {loaded && <>
            ...
            <div className="anim-fade-up delay-3" style={{ display:"flex", gap:16, flexWrap:"wrap", paddingBottom: 32 }}>
      ...
      <style>{`
        @media (max-width: 640px) {
          ...
          /* Mobile card lift on touch */
          .stat-card:active, .scard:active, .fcard:active {
        ...
        <div style={{ display:"grid", gridTemplateColumns:"repeat(auto-fill,minmax(240px,1fr))", gap:16 }}>
          {products.map((p,i) => (
            <div key={p.id}
              ...
              }} className="product-card-inner" onClick={() => setQuickViewProduct(p)}>
                {/* Product visual */}
                <div style={{
  ...
  return (
    <section id="about" className="section-padding" style={{ background:"#0d0c0a", position:"relative", overflow:"hidden" }}>
      ...
      <div className="container-px" style={{ maxWidth:1400, margin:"0 auto", padding:"0 48px", position:"relative", zIndex:1 }}>
        <div ref={ref} className="grid-2col" style={{ gap:80, alignItems:"center", width: "100%" }}>
          <div>
  ...
  return (
    <section id="lookbook" className="section-padding" style={{ background:"#080808" }}>
      ...
      <style>{`
        ...
        @media (max-width: 640px) {
          .lookbook-grid { columns: 2 140px !important; }
        }
        @media (max-width: 480px) {
...
function Contact() {
  ...
  return (
    <section id="contact" className="section-padding" style={{ background:"#080808" }}>
      <div className="container-px" style={{ maxWidth:1400, margin:"0 auto", padding:"0 48px" }}>
        <div ref={ref} className="grid-2col" style={{ gap:96, alignItems:"start", width: "100%" }}>
          <div>
  ...
  return (
    <style>{`
      @media (max-width: 768px) {
        ...
        .hero-section > .container-px { padding-top: 20px !important; }
        .hero-section h1 { font-size: clamp(32px, 9vw, 52px) !important; }
      ...
      @media (max-width: 480px) {
        .hero-section { min-height: 100vh !important; min-height: 100dvh !important; }
        .hero-section h1 { font-size: 28px !important; line-height: 1.1 !important; }
        .hero-section > .container-px { padding-left: 16px !important; padding-right: 16px !important; }
        ...
        #collections .container-px, 
        #bestsellers .container-px, 
        #about .container-px, 
        #testimonials .container-px, 
        #lookbook .container-px, 
        #contact .container-px { padding-left: 16px !important; padding-right: 16px !important; }
        .grid-2col { gap: 40px !important; }
        .grid-stats-4 { grid-template-columns: 1fr 1fr !important; }
        ...
        .drawer-box { width: 100vw !important; }
        .newsletter-row { flex-direction: column !important; gap: 12px !important; }
        .newsletter-row input { border-right: 1px solid rgba(255,255,255,0.1) !important; border-radius: 0 !important; }
