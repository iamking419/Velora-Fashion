...
function QuickViewModal() {
  ...
  return (
    <>
      ...
      <div className="modal-box qv-modal" role="dialog" aria-modal="true" aria-label={`${p.name} quick view`}>
        <div className="qv-grid" style={{ display:"grid", gridTemplateColumns:"1fr 1fr" }}>
          ...
          <div className="qv-details" style={{ padding:"40px 40px 40px 8px" }}>
            ...
            <div style={{ display:"flex", gap:8, flexWrap:"wrap", marginBottom:28 }}>
              {p.sizes.map(s => (
                <button key={s} onClick={() => setSize(s)} className="tap-target" style={{
                  ...
                  fontSize:12, cursor:"pointer", transition:"all 0.25s ease", minHeight:36
                }}>{s}</button>
              ))}
            </div>
      ...
      <div onClick={e => e.stopPropagation()} style={{
        ...
        <div style={{ display:"flex", alignItems:"center", gap:16, borderBottom:"1px solid rgba(201,169,110,0.3)", paddingBottom:16, marginBottom:24 }}>
          ...
          <input ref={inputRef} value={query} onChange={e => setQuery(e.target.value)}
            ...
            style={{ background:"none", border:"none", padding:0, fontSize:20, fontFamily:"'Cormorant Garamond',serif", color:"#f5f0eb" }}/>
  ...
  return (
    <>
      <nav className={`main-nav ${scrolled ? 'nav-scrolled' : ''}`} style={{
        ...
        ...(scrolled ? { background:"rgba(10,10,10,0.85)", backdropFilter:"blur(24px)", WebkitBackdropFilter:"blur(24px)", borderBottom:"1px solid rgba(201,169,110,0.1)" } : {})
      }}>
        <div style={{ maxWidth:1400, margin:"0 auto", display:"flex", alignItems:"center", justifyContent:"space-between" }}>
          <button onClick={() => window.scrollTo({ top:0, behavior:"smooth" })} style={{
            ...
            <span className="serif nav-logo-text" style={{ fontSize:18, letterSpacing:6, color:"#f5f0eb", fontWeight:300 }}>VELORA</span>
          </button>
          ...
          <div style={{ display:"flex", gap:8, alignItems:"center" }}>
            ...
            <button className="btn-primary desktop-shop-btn" style={{ padding:"10px 24px", fontSize:11 }}
      ...
      <div className="mobile-menu" style={{
        ...
        backdropFilter:"blur(32px)", WebkitBackdropFilter:"blur(32px)", display:"flex", flexDirection:"column", alignItems:"center",
        ...
        {links.map((l,i) => (
          <a key={l} href={`#${l.toLowerCase()}`} onClick={e => { e.preventDefault(); setOpen(false); setTimeout(() => scrollToId(l.toLowerCase()), 350); }} style={{
            ...
            fontWeight:300, letterSpacing:6, transition:`all 0.5s cubic-bezier(0.23,1,0.32,1) ${i*0.08}s`,
...
function Hero() {
  ...
  return (
    <section className="hero-section" style={{ position:"relative", height:"100vh", minHeight:700, overflow:"hidden", display:"flex", flexDirection:"column", alignItems:"center", justifyContent:"center" }}>
      ...
      <div className="container-px hero-content" style={{ position:"relative", zIndex:2, maxWidth:1400, margin:"0 auto", padding:"0 48px", width:"100%" }}>
        <div style={{ maxWidth:580, width: "100%" }}>
          {loaded && <>
            ...
            <h1 className="serif anim-fade-up delay-1" style={{
              fontSize:"clamp(40px, 8vw, 110px)", lineHeight:0.95, fontWeight:300,
            ...
            <div className="anim-fade-up delay-3 hero-buttons" style={{ display:"flex", gap:16, flexWrap:"wrap", paddingBottom: 32 }}>
              <button className="btn-primary" onClick={() => scrollToId("collections")} style={{ minHeight: 48, display: "inline-flex", alignItems: "center", justifyContent: "center" }}>Explore Collection</button>
              <button className="btn-outline" onClick={() => scrollToId("about")} style={{ minHeight: 48, display: "inline-flex", alignItems: "center", justifyContent: "center" }}>Our Story</button>
            </div>
          </>}
        </div>
      </div>
      ...
      <div className="hero-scroll-indicator" style={{
        ...
        alignItems:"center", gap:8, opacity:0.5, zIndex: 3
      }}>
      ...
      <div className="container-px" style={{ maxWidth:1400, margin:"0 auto", padding:"0 48px" }}>
        <div ref={ref} style={{ marginBottom:72, display:"flex", justifyContent:"space-between", alignItems:"flex-end", flexWrap:"wrap", gap:24 }}>
          <div>
            ...
            <h2 className={`serif ${inView?"anim-fade-up delay-1":""}`} style={{ fontSize:"clamp(32px,5vw,72px)", fontWeight:300, marginTop:16 }}>
              Our Collections
            </h2>
          </div>
          <button className={`btn-outline ${inView?"anim-fade-up delay-2":""}`} onClick={() => scrollToId("bestsellers")}>View All</button>
        </div>
        <div className="collections-grid" style={{ display:"grid", gridTemplateColumns:"repeat(auto-fit,minmax(240px,1fr))", gap:2 }}>
          {cats.map((c,i) => (
    ...
    <section id="bestsellers" className="section-padding" style={{ background:"#080808" }}>
      <div className="container-px" style={{ maxWidth:1400, margin:"0 auto", padding:"0 48px" }}>
        <div ref={ref} style={{ textAlign:"center", marginBottom:72 }}>
          ...
          <h2 className={`serif ${inView?"anim-fade-up delay-1":""}`} style={{ fontSize:"clamp(32px,5vw,72px)", fontWeight:300, marginTop:16, marginBottom:20 }}>
            Best Sellers
          </h2>
          ...
          {products.map((p,i) => (
            <div key={p.id}
              ...
              <div className="product-card-inner" style={{
                background:p.color, height:340, position:"relative", overflow:"hidden",
                ...
                <button onClick={e => { e.stopPropagation(); toggleWish(p); }} style={{
                  ...
                  border:"none", cursor:"pointer", width:42, height:42, display:"flex",
                ...
                <div className="qv-reveal" style={{
                  ...
                  <button style={{
                    ...
                    color:"#C9A96E", padding:"12px", fontSize:11, letterSpacing:3,
                    textTransform:"uppercase", cursor:"pointer", fontFamily:"Inter,sans-serif",
                    transition:"all 0.3s", minHeight:44, WebkitTapHighlightColor: "transparent"
  ...
  return (
    <section id="about" className="section-padding" style={{ background:"#0d0c0a", position:"relative", overflow:"hidden" }}>
      ...
      <div className="container-px" style={{ maxWidth:1400, margin:"0 auto", padding:"0 48px", position:"relative", zIndex:1 }}>
        <div ref={ref} className="grid-2col about-grid" style={{ gap:80, alignItems:"center", width: "100%" }}>
          <div>
  ...
  return (
    <section className="section-padding" style={{ background:"#0d0c0a", position:"relative", overflow:"hidden" }}>
      ...
      <div ref={ref} className="container-px" style={{ maxWidth:700, margin:"0 auto", padding:"0 48px", textAlign:"center", position:"relative" }}>
        ...
        <h2 className={`serif ${inView?"anim-fade-up delay-1":""}`} style={{ fontSize:"clamp(32px,5vw,64px)", fontWeight:300, marginTop:20, marginBottom:20 }}>
    ...
    <section className="section-padding" style={{ background:"#0a0a0a" }}>
      <div className="container-px" style={{ maxWidth:820, margin:"0 auto", padding:"0 48px" }}>
        <div ref={ref} style={{ textAlign:"center", marginBottom:72 }}>
          ...
          <h2 className={`serif ${inView?"anim-fade-up delay-1":""}`} style={{ fontSize:"clamp(32px,5vw,64px)", fontWeight:300, marginTop:16 }}>
            FAQ
          </h2>
        </div>
        <div>
      ...
      <div className="container-px" style={{ maxWidth:1400, margin:"0 auto", padding:"0 48px" }}>
        <div ref={ref} className="grid-2col contact-grid" style={{ gap:96, alignItems:"start", width: "100%" }}>
          <div>
            ...
            <h2 className={`serif ${inView?"anim-fade-up delay-1":""}`} style={{ fontSize:"clamp(32px,4vw,56px)", fontWeight:300, marginTop:20, marginBottom:32 }}>
          ...
          <div className={`contact-form-col ${inView?"anim-fade-up delay-3":""}`}>
            {sent ? (
              ...
              <div style={{ display:"flex", flexDirection:"column", gap:4, marginTop:40 }} className="contact-form-fields">
...
function Footer() {
  ...
  return (
    <footer style={{ background:"#060606", borderTop:"1px solid rgba(255,255,255,0.04)" }}>
      <div style={{ maxWidth:1400, margin:"0 auto", padding:"60px 24px 40px" }} className="footer-inner">
  ...
  return (
    <style>{`
      ...
      @media (max-width: 768px) {
        ...
        .nav-logo-text { font-size: 16px !important; letter-spacing: 4px !important; }
        .hero-section { min-height: 100vh !important; min-height: 100dvh !important; padding-top: 80px !important; }
        .hero-content { padding-top: 20px !important; }
        .hero-section h1 { font-size: clamp(36px, 10vw, 52px) !important; line-height: 0.95 !important; }
        ...
        .hero-stats-row > div { flex: none !important; }
        .hero-stats-row .serif { font-size: 22px !important; }
        .hero-stats-row span:last-child { font-size: 10px !important; }
        .hero-scroll-indicator { display:none !important; }
        .hero-deco-1, .hero-deco-2 { display:none !important; }
        .collections-grid { grid-template-columns: 1fr 1fr !important; }
        .collection-card > div { height: 360px !important; padding: 24px !important; }
        ...
        .qv-details { padding: 28px 24px !important; }
        .qv-image { min-height: 240px !important; padding: 24px !important; }
        .footer-inner { padding: 40px 20px 24px !important; }
        .toast-stack { left: 16px !important; right: 16px !important; bottom: 16px !important; align-items: stretch !important; }
        .wishlist-dropdown { 
      ...
      @media (max-width: 480px) {
        ...
        .main-nav { padding: 14px 16px !important; }
        .hero-section h1 { font-size: 32px !important; }
        .hero-section p { font-size: 13px !important; line-height: 1.7 !important; }
        .hero-stats-row { gap: 12px !important; padding: 16px 16px !important; }
        .hero-stats-row .serif { font-size: 20px !important; }
        .collections-grid { grid-template-columns: 1fr !important; }
        .collection-card > div { height: 320px !important; }
        ...
        .grid-footer { grid-template-columns: 1fr !important; row-gap: 32px !important; }
        ...
        .testimonial-card { padding: 40px 20px !important; min-height: 360px !important; }
        .testimonial-card p.serif { font-size: 16px !important; }
        .mobile-menu a { font-size: 28px !important; letter-spacing: 4px !important; }
        .modal-box { width: 94vw !important; }
        .qv-image { min-height: 200px !important; }
        .qv-details h3 { font-size: 24px !important; }
      ...
      @media (max-width: 380px) {
        ...
        .product-card-inner { height: 260px !important; }
        .btn-primary, .btn-outline { padding: 12px 24px !important; font-size: 11px !important; letter-spacing: 2px !important; }
      }
